		...
		_showPicker: function(oElement)
		{
			...
			if(oDTP.oData.oInputElement === null)
			{
				...
				if(!oDTP.settings.isPopup)
				{
					...
					//var iElemRight = $(window).width() - ($(oDTP.oData.oInputElement).offset().left + iElemWidth);
				
					//$(oDTP.element).css({position: "absolute", top: iElemTop, right: iElemRight, width: iElemWidth, height: "auto"});
					$(oDTP.element).css({position: "absolute", height: "auto"});
				}
